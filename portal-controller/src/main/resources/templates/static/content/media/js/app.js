...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "/Content/media/css/" + color + ".css");
    ...
    return {
        ...
        init: function () {
            ...
            $('#navBar li a').each(function () {
                if (url.endsWith($(this).attr('href'))) {
                    $('#navBar li').removeClass('active open');
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el);
            el.block({
                message: '<img src="/content/images/loading.gif" align="">',
