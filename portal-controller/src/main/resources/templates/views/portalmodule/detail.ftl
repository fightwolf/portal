                            ...
                            <div class="box-content">
                                <div class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="txtmodule_name" type="text" class="m-wrap medium typeahead"
                                                   value="<#if item??>${item.moduleName!}</#if>"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="txtmodule_code" type="text" class="m-wrap medium typeahead"
                                                   value="<#if item??>${item.moduleCode!}</#if>"
                                                   data-provide="typeahead"
                                                   data-items="4"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <!--这里的富文本div标签要换script-->
                                            <div id="txtContent" name="txtContent" type="text/plain"
                                                 style="width:100%;display:block;"><#if item??>${item.describes!}</#if></div>
                                        </div>
                                    </div>
                                    <div class="control-group">
...
$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        var data = {};
        data.Id = $("#txtId").val();
        data.module_name = $("#txtmodule_name").val();
        data.module_code = $("#txtmodule_code").val();
        data.parent_code = $("#txtparent_code").val();
        data.icon = $("#imgicon").attr("src");
        data.link = $("#txtlink").val();
        data.describes = ue.getContent();
        data.ar = $("#txtar").val();
        data.status = $("#txtstatus").val();
        data.creator_id = $("#txtcreator_id").val();
        data.creator_name = $("#txtcreator_name").val();
        $.post("/PortalModule/save", {datas: JSON.stringify(data)}, function (data) {
            if (data.code === 0) {
                alert('操作成功!');
                window.location.href = '/portalmodule/list';
            } else {
