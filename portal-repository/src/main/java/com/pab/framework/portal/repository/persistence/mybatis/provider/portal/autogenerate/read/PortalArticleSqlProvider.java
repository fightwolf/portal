...
public class PortalArticleSqlProvider {
    ...
    public String countByExample(PortalArticleExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`portal_article`");
    ...
    public String selectByExampleWithBLOBs(PortalArticleExample example) {
        BEGIN();
    ...
    public String selectByExample(PortalArticleExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("`Id`");
        } else {
