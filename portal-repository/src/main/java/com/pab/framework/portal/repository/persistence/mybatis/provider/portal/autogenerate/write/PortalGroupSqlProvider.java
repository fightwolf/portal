...
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalGroupExample.Criteria;
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalGroupExample.Criterion;
...
public class PortalGroupSqlProvider {

    public String deleteByExample(PortalGroupExample example) {
        BEGIN();
        DELETE_FROM("`portal_group`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(PortalGroup record) {
        BEGIN();
        INSERT_INTO("`portal_group`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PortalGroup record = (PortalGroup) parameter.get("record");
        PortalGroupExample example = (PortalGroupExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(PortalGroup record) {
        BEGIN();
        UPDATE("`portal_group`");
    ...
    protected void applyWhere(PortalGroupExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
