...
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalModuleExample.Criteria;
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalModuleExample.Criterion;
...
public class PortalModuleSqlProvider {

    public String deleteByExample(PortalModuleExample example) {
        BEGIN();
        DELETE_FROM("`portal_module`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(PortalModule record) {
        BEGIN();
        INSERT_INTO("`portal_module`");
        ...
        if (record.getModuleCode() != null) {
            VALUES("`module_code`", "#{moduleCode,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PortalModule record = (PortalModule) parameter.get("record");
        PortalModuleExample example = (PortalModuleExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(PortalModule record) {
        BEGIN();
        UPDATE("`portal_module`");
    ...
    protected void applyWhere(PortalModuleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
