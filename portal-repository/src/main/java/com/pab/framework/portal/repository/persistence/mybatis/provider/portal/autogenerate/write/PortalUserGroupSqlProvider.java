...
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalUserGroupExample.Criteria;
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalUserGroupExample.Criterion;
...
public class PortalUserGroupSqlProvider {

    public String deleteByExample(PortalUserGroupExample example) {
        BEGIN();
        DELETE_FROM("`portal_user_group`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(PortalUserGroup record) {
        BEGIN();
        INSERT_INTO("`portal_user_group`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PortalUserGroup record = (PortalUserGroup) parameter.get("record");
        PortalUserGroupExample example = (PortalUserGroupExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(PortalUserGroup record) {
        BEGIN();
        UPDATE("`portal_user_group`");
    ...
    protected void applyWhere(PortalUserGroupExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
