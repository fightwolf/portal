...
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalUserRoleExample.Criteria;
import com.pab.framework.portal.repository.persistence.mybatis.entity.portal.PortalUserRoleExample.Criterion;
...
public class PortalUserRoleSqlProvider {

    public String deleteByExample(PortalUserRoleExample example) {
        BEGIN();
        DELETE_FROM("`portal_user_role`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(PortalUserRole record) {
        BEGIN();
        INSERT_INTO("`portal_user_role`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PortalUserRole record = (PortalUserRole) parameter.get("record");
        PortalUserRoleExample example = (PortalUserRoleExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(PortalUserRole record) {
        BEGIN();
        UPDATE("`portal_user_role`");
    ...
    protected void applyWhere(PortalUserRoleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
